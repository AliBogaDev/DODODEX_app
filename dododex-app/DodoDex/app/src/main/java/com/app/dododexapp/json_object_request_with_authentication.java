...
public class json_object_request_with_authentication extends JsonObjectRequest {

    private final Context context;

    public json_object_request_with_authentication(String url, Response.Listener<JSONObject> listener, @Nullable Response.ErrorListener errorListener, Context context) {
