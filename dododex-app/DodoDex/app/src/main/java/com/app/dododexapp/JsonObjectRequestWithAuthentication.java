...
public class JsonObjectRequestWithAuthentication extends JsonObjectRequest {
    ...
    public JsonObjectRequestWithAuthentication(int method, String url, @Nullable JSONObject jsonRequest, Response.Listener<JSONObject>
            listener, @Nullable Response.ErrorListener errorListener, Context context) {
